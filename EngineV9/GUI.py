...
class ClassBoardGameGUI:
    ...
    def handle_button_engine(self, pos):
                ...
                for event in pygame.event.get():
                    if event.type == pygame.QUIT:
                        ...
                        if event.button == 1:  # Left mouse button click
                            ...
                            self.handle_button_engine(event.pos)
