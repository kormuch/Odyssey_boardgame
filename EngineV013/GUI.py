...
class ClassBoardGameGUI:
    def __init__(self):
        ...
        # menu - position QUIT button between image and progress bar (after button_width is defined)
        self.button_quit_pos_x = self.WIDTH // 2 - self.button_width // 2  # Center horizontally
        self.button_quit_pos_y = (self.HEIGHT // 3)  # Between image space and progress bar
    ...
    def draw_textbox(self, text):
        """Draws the textbox with the given text in the bottom right."""
        textbox_font = pygame.font.Font(None, 18)
        ...
        textbox_height = total_height
        textbox_x = self.WIDTH - textbox_width - 20  # 20 pixels from right edge
        textbox_y = self.HEIGHT - textbox_height - 80  # Above action buttons with some margin
    ...
    def draw_paths(self):
        ...
        path_spacing = 60
        path_offset_x = 50  # Move further left
        ...
        for path in range(4):
            ...
            # Draw path label ABOVE the path with more space
            font = pygame.font.Font(None, 24)
            label = font.render(path_name.capitalize(), True, (0, 0, 0))
            label_y = path_start_y + path * path_spacing - 35  # More space (35 pixels above circles)
    ...
    def draw_game_control_buttons(self):
        """Draw game control buttons in upper left"""
        start_x = 20
        start_y = 20
        button_spacing = 5
    ...
    def handle_button_click(self, pos):
        ...
        quit_button_rect = pygame.Rect(self.button_quit_pos_x, self.button_quit_pos_y, self.button_width, self.button_height)
    ...
    def get_quit_button_rect(self):
        """Helper method to ensure quit button position consistency"""
        return pygame.Rect(self.button_quit_pos_x, self.button_quit_pos_y, self.button_width, self.button_height)

    def draw_button_quit(self):
        """Draw quit button between image and progress bar"""
        button_rect = self.get_quit_button_rect()
        hover = button_rect.collidepoint(self.mouse_pos)
